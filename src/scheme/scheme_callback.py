...
def callback_sncf():
    param_co.state_hu["train_operator"]["broker_port"] = dpg.get_value("sncf_broker_port")
    param_co.state_hu["train_operator"]["mqtt_topic"] = dpg.get_value("sncf_mqtt_topic")
    param_co.state_hu["train_operator"]["mqtt_client"] = dpg.get_value("hu_mqtt_client_name")
    https_client_post.post_state("hu", param_co.state_hu)
    https_client_post.post_param_value("hu", None, "train_operator", "reset")
...
def callback_module_interface():
    ...
    if(l1_port != l2_port):
        ...
        param_co.state_hu["module_interface"]["sock_server_l1_port"] = dpg.get_value("co_sock_server_l1_port")
        param_co.state_hu["module_interface"]["sock_server_l2_port"] = dpg.get_value("co_sock_server_l2_port")
        https_client_post.post_state("hu", param_co.state_hu)
