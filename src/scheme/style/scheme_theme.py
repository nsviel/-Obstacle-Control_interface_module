...
def colorize_node():
    ...
    dpg.bind_item_theme("node_control", layer_cloud)
    dpg.bind_item_theme("node_capture", layer_train)
    dpg.bind_item_theme("node_train", layer_train)
    dpg.bind_item_theme(object.object.edge_1.ID_node, layer_edge)
    dpg.bind_item_theme("node_slam", layer_edge)
    dpg.bind_item_theme("node_ai", layer_edge)
    dpg.bind_item_theme("node_data", layer_edge)
    dpg.bind_item_theme(object.object.edge_2.ID_node, layer_edge)
...
def colorize_item():
    ...
    dpg.bind_item_theme(object.object.ssd.ID_activated, checkbox)
    dpg.bind_item_theme(object.object.train.ID_l1_activated, checkbox)
    dpg.bind_item_theme(object.object.train.ID_l2_activated, checkbox)
    dpg.bind_item_theme(object.object.edge_1.slam.ID_setting_with_slam, checkbox)

    dpg.bind_item_theme(object.object.ssd.ID_path_add, input_text)
    dpg.bind_item_theme(object.object.ssd.ID_path, input_text)
    dpg.bind_item_theme(object.object.operator.ID_mqtt_topic, input_text)
    dpg.bind_item_theme(object.object.train.ID_l1_ip, input_text)
    dpg.bind_item_theme(object.object.train.ID_l2_ip, input_text)
    dpg.bind_item_theme(object.object.train.ID_l1_motor_speed, input_text)
    dpg.bind_item_theme(object.object.train.ID_l2_motor_speed, input_text)
    dpg.bind_item_theme(object.object.edge_1.ai.ID_setting_threshold, input_text)
    dpg.bind_item_theme(object.object.edge_1.ai.ID_setting_lidar_height, input_text)

    dpg.bind_item_theme(object.object.control.ID_sock_server_l1_port, input_text)
    dpg.bind_item_theme(object.object.control.ID_sock_server_l2_port, input_text)
    dpg.bind_item_theme(object.object.capture.ID_http_server_port, input_text)
    dpg.bind_item_theme(object.object.edge_1.ID_sock_server_l1_port, input_text)
    dpg.bind_item_theme(object.object.edge_1.ID_sock_server_l2_port, input_text)
    dpg.bind_item_theme(object.object.edge_1.ID_mqtt_client_name, input_text)
    dpg.bind_item_theme(object.object.operator.ID_mqtt_broker_port, input_text)
    dpg.bind_item_theme(object.object.edge_1.ID_sock_client_l1_lidar_main, input_text)
    dpg.bind_item_theme(object.object.edge_1.slam.ID_setting_cam_view, input_text)
    dpg.bind_item_theme(object.object.train.ID_l1_sock_client_port, input_text)
    dpg.bind_item_theme(object.object.train.ID_l2_sock_client_port, input_text)

    dpg.bind_item_theme(object.object.edge_1.ID_wallet, input_text)
    dpg.bind_item_theme(object.object.capture.ID_wallet, input_text)
    dpg.bind_item_theme(object.object.edge_2.ID_wallet, input_text)
    dpg.bind_item_theme(object.object.edge_1.slam.ID_wallet, input_text)
    dpg.bind_item_theme(object.object.edge_1.ai.ID_wallet, input_text)
    dpg.bind_item_theme(object.object.operator.ID_wallet, input_text)
    dpg.bind_item_theme(object.object.train.ID_l1_wallet, input_text)
    dpg.bind_item_theme(object.object.train.ID_l2_wallet, input_text)

    dpg.bind_item_theme(object.object.capture.ID_ip, input_text)
    dpg.bind_item_theme(object.object.edge_1.ID_ip, input_text)
    dpg.bind_item_theme(object.object.edge_2.ID_ip, input_text)
    dpg.bind_item_theme(object.object.edge_1.ai.ID_ip, input_text)
    dpg.bind_item_theme(object.object.edge_1.slam.ID_ip, input_text)
    dpg.bind_item_theme(object.object.operator.ID_ip, input_text)
