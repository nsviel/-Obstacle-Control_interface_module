...
def colorize_node():
    ...
    dpg.bind_item_theme("node_edge_2", layer_edge)
...
def colorize_item():
    ...
    dpg.bind_item_theme("edge_1_sock_server_l1_port", input_text)
    dpg.bind_item_theme("edge_1_sock_server_l2_port", input_text)
    dpg.bind_item_theme("edge_1_mqtt_client_name", input_text)
    dpg.bind_item_theme("trainope_broker_port", input_text)
    dpg.bind_item_theme("edge_1_sock_client_l1_combo_lidar_main", input_text)
    ...
    dpg.bind_item_theme("edge_1_wallet", input_text)
    dpg.bind_item_theme("capture_wallet", input_text)
    dpg.bind_item_theme("edge_2_wallet", input_text)
    ...
    dpg.bind_item_theme("edge_1_ip", input_text)
    dpg.bind_item_theme("edge_2_ip", input_text)
