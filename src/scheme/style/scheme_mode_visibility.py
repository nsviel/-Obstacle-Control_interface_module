...
def set_mode_dev():
    ...
    dpg.show_item("edge_1_mqtt_visible")
    dpg.show_item("trainope_mqtt_topic_visible")
    dpg.show_item("edge_1_ID_visible")
    dpg.show_item("geo_status")
    dpg.show_item("l2_plot_visible")

    # IP
    dpg.show_item("edge_1_ip_visible")
    ...
    dpg.show_item("edge_1_sock_client_l1_o")
    dpg.show_item("edge_1_sock_server_l1_i")
    dpg.show_item("link_capture_edge_l1_sock")
    dpg.show_item("edge_1_sock_client_l1_i")
    dpg.show_item("l1_line_visible")
    dpg.show_item("l1_params_visible")
    dpg.show_item("l1_speedge_2_visible")
    dpg.show_item("l1_port_visible")
    dpg.show_item("edge_1_source_1")
    dpg.show_item("edge_1_source_2")
    dpg.show_item("l2_line_visible")
    dpg.show_item("l2_params_visible")
    dpg.show_item("l2_speedge_2_visible")
    dpg.show_item("edge_1_sock_client_l2_source")
    dpg.show_item("l2_port_visible")
    dpg.show_item("edge_1_sock_client_l2_o")
    ...
    dpg.show_item("edge_1_sock_server_l2_i")
    ...
    dpg.show_item("edge_1_thread_visible")
    ...
    dpg.show_item("edge_1_port_l1_visible")
    dpg.show_item("edge_1_port_l2_visible")
    ...
    dpg.show_item("edge_1_sock_server_l1_o")
...
def set_mode_demo():
    ...
    dpg.hide_item("edge_1_mqtt_visible")
    dpg.hide_item("trainope_mqtt_topic_visible")
    dpg.hide_item("edge_1_ID_visible")
    ...
    # IP
    dpg.hide_item("edge_1_ip_visible")
    ...
    dpg.hide_item("l1_speedge_2_visible")
    dpg.hide_item("l1_port_visible")
    dpg.hide_item("edge_1_source_1")
    dpg.hide_item("edge_1_source_2")
    dpg.hide_item("edge_1_sock_client_l1_i")
    dpg.hide_item("edge_1_sock_client_l1_o")

    dpg.hide_item("l2_line_visible")
    dpg.hide_item("l2_params_visible")
    dpg.hide_item("l2_speedge_2_visible")
    dpg.hide_item("l2_port_visible")
    dpg.show_item("edge_1_sock_client_l2_o")
    dpg.hide_item("edge_1_sock_client_l2_o")
    dpg.hide_item("edge_1_sock_client_l2_source")
    if(param_interface.lidar_main == "lidar_1"):
        ...
        dpg.hide_item("edge_1_sock_server_l2_i")
        dpg.hide_item("edge_1_sock_client_l2_o")
    ...
    if(param_interface.lidar_main == "lidar_2"):
        ...
        dpg.hide_item("edge_1_sock_server_l1_i")
    ...
    # Nb threads
    dpg.hide_item("edge_1_thread_visible")
    dpg.hide_item("capture_thread_visible")

    # HTTP ports
    dpg.hide_item("capture_http_port_visible")
    dpg.hide_item("edge_1_http_port_visible")
    #dpg.hide_item("edge_2_http_port_visible")
    dpg.hide_item("edge_1_http_server_o")
    dpg.hide_item("edge_1_http_client_o")

    # Socket ports
    dpg.hide_item("interface_port_l1_visible")
    dpg.hide_item("interface_port_l2_visible")
    dpg.hide_item("edge_1_port_l1_visible")
    dpg.hide_item("edge_1_port_l2_visible")
    ...
    dpg.hide_item("edge_1_sock_server_l1_o")
