...
def update_link_color():
    # module_interface
    update_link_con(param_interface.state_interface["edge"]["http_connected"], "link_interface_edge_1_http")
    ...
    #update_link_con(param_interface.state_edge["edge_next"]["http_connected"], "link_edge_edge_2_http")
    #update_link_sock(param_interface.state_edge["edge_next"]["sock_connected"], "link_edge_edge_2_sock")
    ...
    # Edge
    #update_link_con(param_interface.state_edge["edge_next"]["http_connected"], "link_edge_2_edge_1_http")
    #update_link_sock(param_interface.state_edge["edge_next"]["sock_connected"], "link_edge_2_edge_sock")

    # cloud_car
    update_link_con(param_interface.state_edge["cloud_car"]["http_connected"], "link_va_hu")

    # AI
    update_link_con(param_interface.state_edge["component_ai"]["http_connected"], "link_ai_edge_1_http")
