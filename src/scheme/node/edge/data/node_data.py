...
def design_node():
    with dpg.node(label="Processed data", tag="node_data"):
        ...
        scheme_function.add_variable_simple("Frame:", "nb_frame", "ID_nb_frame_visibility")
        scheme_function.add_variable_simple("Prediction:", "nb_prediction", "ID_nb_prediction_visibility")
