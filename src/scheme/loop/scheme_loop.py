...
def loop_packet():
    dpg.set_value(object.object.train.ID_l1_stat_packet, param_interface.state_capture["lidar_1"]["packet"]["value"])
    dpg.set_value(object.object.train.ID_l2_stat_packet, param_interface.state_capture["lidar_2"]["packet"]["value"])
...
def loop_lidar_throughput():
    ...
    dpg.set_value(object.object.train.ID_l1_throughtput_value, value)
    dpg.set_value(object.object.train.ID_l1_throughtput_range, range)
    ...
    range = "%.2f, %.2f, %.2f"% (min, mean, max)
    dpg.set_value(object.object.train.ID_l2_throughtput_value, value)
    dpg.set_value(object.object.train.ID_l2_throughtput_range, range)
