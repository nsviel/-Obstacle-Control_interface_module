...
def determine_path():
    ...
    param_co.path_capture = os.path.join(param_co.ssd_path, "capture")
    param_co.path_dir_l1 = os.path.join(param_co.path_capture, "lidar_1")
    param_co.path_dir_l2 = os.path.join(param_co.path_capture, "lidar_2")
    param_co.path_file_l1 = os.path.join(param_co.path_dir_l1, "capture_" + date + "_" + param_li.path_name + ".pcap")
    param_co.path_file_l2 = os.path.join(param_co.path_dir_l2, "capture_" + date + "_" + param_li.path_name + ".pcap")
