...
class Control_window(window.Window):
    ...
    def colorize_window(self):
        colorization.colorize_item(self.ID.ID_setting_edge_selection, "node_sub")
    ...
    # Update function
    def update(self):
        colorization.colorize_status(self.ID.ID_status, param_control.state_control["control"]["info"]["status"])
        dpg.set_value(self.ID.ID_status, param_control.state_control["control"]["info"]["status"])
        dpg.set_value(self.ID.ID_ip, param_control.state_control["control"]["info"]["ip"])
        dpg.set_value(self.ID.ID_thread, param_control.state_control["control"]["info"]["nb_thread"])
