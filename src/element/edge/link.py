...
class Link:
    ...
    def update(self):
        colorization.colorize_link_http(param_control.state_edge["component"]["slam"]["http_connected"], self.link_http_hub_slam)
        colorization.colorize_link_http(param_control.state_edge["component"]["ai"]["http_connected"], self.link_http_hub_ai)
        ...
        colorization.colorize_link_socket(param_control.state_edge["component"]["slam"]["sock_connected"], self.link_sock_hub_slam)
