...
class Socket_l1(daemon.Daemon):
    def thread_init(self):
        port = param_control.state_control["self"]["sock_server_l1_port"]
    ...
    def thread_function(self):
        try:
            ...
            param_control.state_control["edge_1"]["sock_l1_connected"] = True
        except:
            param_control.state_control["edge_1"]["sock_l1_connected"] = False
